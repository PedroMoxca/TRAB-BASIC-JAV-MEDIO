...
public class ProcessoSeletivo {
    public static void main(String[] args) {
        ...
        static void entrandoEmContato(String candidato;){
            ...
            do{
                //elas precisarão sofrer alterações senão iram entrar num looping
            atendeu = atender();
...
//
    ...
    //        System.out.println("O candidato " + candidato + " Solicitou este valor de salário pretendido " + valorPretendido());
